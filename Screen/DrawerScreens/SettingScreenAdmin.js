    ...
    const Listusers = () =>(
        ...
        <SafeAreaView key={usr.username} style={{flex: 1,   backgroundColor: '#ffffff',marginBottom :10}}>
            <View style={styles.container}>
              ...
              <Text style={{ alignContent:'center',alignItems:'center', fontWeight: 'bold', color:COLORS.secondary, fontSize: 20 }}>{usr.username}</Text>
              ...
              <TouchableOpacity style={styles.commandButton} onPress={() => {
                navigation.navigate('SettingEditProfil', {datauser : usr});}}>
